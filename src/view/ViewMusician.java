...
public class ViewMusician extends JFrame{

	private static final long serialVersionUID = 1L;
	static ViewMusician frame;
	...
	public ViewMusician() {
		...
		JLabel lblViewMusicianManagement = new JLabel("Recording Company Mgmt");
		lblViewMusicianManagement.setFont(SwingHelper.customFont(18));
		lblViewMusicianManagement.setForeground(Color.GRAY);
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(64)
							.addComponent(lblViewMusicianManagement))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(140)
